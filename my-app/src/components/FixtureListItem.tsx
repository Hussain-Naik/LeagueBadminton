...
const FixtureListItem: React.FC<FixtureProps> = ({
  props,
  games,
  leaderboard,
}) => {
  ...
  return (
    <div className="col-12 lg:col-6">
      <div className="flex justify-content-between align-items-center surface-0 shadow-2 p-3 border-1 border-50 border-round">
        <div
          className={`flex-grow-1 ${winner === 2 ? 'opacity-10' :''}`}
          onClick={() => {
            setWinner(1);
          }}
        >
        ...
        <div
          className={`flex-grow-1 ${winner === 1 ? 'opacity-10' :''}`}
          onClick={() => {
            setWinner(2);
          }}
        >
