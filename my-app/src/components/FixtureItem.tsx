...
const FixtureItem: React.FC<FixtureProps> = ({ props, setGames, games, setLoaded, loaded, leaderboard }) => {
  
  const getting = localStorage.getItem("sessionLeaderboard");
  ...
  const [sheetData, setSheetData] = useState([
    {
      ...
      name: games.length + 1,
      team: 1,
      player: data.filter((player:any) => player.seed === team1_player1_index)[0]
        .player,
      win: 0,
    },
    {
      ...
      name: games.length + 1,
      team: 1,
      player: data.filter((player:any) => player.seed === team1_player2_index)[0]
        .player,
      win: 0,
    },
    {
      ...
      name: games.length + 1,
      team: 2,
      player: data.filter((player:any) => player.seed === team2_player1_index)[0]
        .player,
      win: 0,
    },
    {
      ...
      name: games.length + 1,
      team: 2,
      player: data.filter((player:any) => player.seed === team2_player2_index)[0]
        .player,
      win: 0,
    },
  ]);
